...
variable "sql_init_host_path" {
  type    = string
  default = ""
}

variable "artifact_download_url_ttl_seconds" {
  type    = number
  default = 600
}
...
variable "internal_service_tokens" {
  type = string
}
...
variable "github_draft_sync_enabled" {
  type    = string
  default = "false"
}
...
variable "agent_execution_args" {
  type    = string
  default = "[]"
}

variable "agent_execution_timeout_seconds" {
  type    = string
  default = "600"
}

variable "agent_execution_auto_create_pr" {
  type    = string
  default = "false"
}

variable "extension_max_inline_artifact_bytes" {
  type    = string
  default = "1048576"
}

variable "extension_max_total_inline_artifact_bytes" {
  type    = string
  default = "5242880"
}