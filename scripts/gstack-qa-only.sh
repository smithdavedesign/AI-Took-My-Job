...
# The /qa-only skill produces human-readable stdout. To capture structured findings
...
When the bug hunt — functional issues with repro steps, no fixes is complete, write the following JSON to the file at
