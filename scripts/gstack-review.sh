...
# The /review skill produces human-readable stdout. To capture structured findings
...
When the code review — security, logic, type safety is complete, write the following JSON to the file at
